...
- Name: login.spec.ts >> SCRUM-7 | User can click login button >> Clicking login with valid credentials navigates away from login page
...
Received string: "https://www.automationexercise.com/login"
Timeout: 5000ms

Call log:
  - Expect "not toHaveURL" with timeout 5000ms
    13 × unexpected value "https://www.automationexercise.com/login"
